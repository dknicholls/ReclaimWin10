...
New-ItemProperty -path $registryPath -name RemoveWindowsStore -value 1 -propertytype dword -force | out-null

# Enable the Microsoft Store
# $registryPath = "HKLM:\SOFTWARE\Policies\Microsoft\WindowsStore"
# new-item -path $registryPath -Force
# New-ItemProperty -path $registryPath -name RemoveWindowsStore -value 0 -propertytype dword -force | out-null

# Disable Hibernate on system shutdown and add hibernate as an option
$registryPath = "hklm:\system\CurrentControlSet\Control\Session Manager\power"
Set-ItemProperty -path $registryPath -name hiberbootenabled -type dword -value 0
$registryPath = "hklm:\system\CurrentControlSet\Control\power"
New-ItemProperty -path $registryPath -name HibernateEnabled -value 1 -PropertyType dword -force | out-null

# Enable Hibernate on system shutdown and remove hibernate as an option
# $registryPath = "hklm:\system\CurrentControlSet\Control\Session Manager\power"
# Set-ItemProperty -path $registryPath -name hiberbootenabled -type dword -value 1
# $registryPath = "hklm:\system\CurrentControlSet\Control\power"
# New-ItemProperty -path $registryPath -name HibernateEnabled -value 0 -PropertyType dword -force | out-null
